...
<main>
    <div class="container ">
        ...
        <div class="col-sm-6 col-12 mt-4">
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Culpa unde tempora:</p>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-4 col-12">
            <div class="row card m-1">
                <img src="https://nelsontarche.com.ar/images/abmclientes.png" alt="ABM Clientes" title="ABM Clientes" class="img-fluid">
                <div class="col-12 color-gradiente py-3">
                    <h2>ABM Clientes</h2>
                </div>
                <div class="col-12 py-3">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea rem natus consequatur recusandae ullam fugit fuga tempore id!</p>
                </div>
        ...
        <div class="col-sm-4 col-12">
            <div class="row card m-1">
                ...
                <div class="col-12 py-3">
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ea rem natus consequatur recusandae ullam fugit fuga tempore id!
                </p>
                </div>
                <div class="row p-3 pb-0">
                    <div class="col-6">
